const JSON_FIELDS = ['attendance', 'lineup', 'strategy_priorities', 'guest_players', 'goals'];
const BOOL_FIELDS = ['count_goalie_as_playing_time', 'has_goalie', 'avoid_consecutive_bench', 'goalie_counts_as_bench'];
